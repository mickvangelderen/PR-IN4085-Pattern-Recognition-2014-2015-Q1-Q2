...
train_indices = interesting_speckle;
...
mappings = ...
    ...
    ; 'w/o speckles', im_fill_norm(train_images*im_filter_speckles(20)*im_box(0), side, .5) ...
    ; 'w/o speckles', im_fill_norm(train_images*im_filter_speckles(40)*im_box(0), side, .5) ...
    ; 'w/o speckles', im_fill_norm(train_images*im_filter_speckles(60)*im_box(0), side, .5) ...
    ; 'w/o speckles', im_fill_norm(train_images*im_filter_speckles(80)*im_box(0), side, .5) ...
};
...
imwrite(imresize(out, 4, 'box'), 'preprocessing_speckle_evaluation.png');